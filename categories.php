...
<div class="content">
	<div class="grids">
		...
		$high=$_GET['high'];
							include"dbcon.php";
			$sql = "SELECT sr_no,topic,LEFT(few_d,500) AS few_da,content,dat,pic1 FROM u440823744_sec.news WHERE category LIKE '%$news_cat%' ORDER BY sr_no DESC LIMIT $low,$high " ;
