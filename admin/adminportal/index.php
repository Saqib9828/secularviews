		...
		<div class="news-paper">
			...
			<div class="main-content">		
				<div class="col-md-9 total-news">
					<div class="slider">
						...
						<h5 class="breaking">Latest news</h5>
					</div>	
				<div class="posts">
			...
			$sql = "SELECT sr_no,LEFT(topic,200) AS topica,few_d,pic1 FROM news WHERE category LIKE '%University_News%' ORDER BY sr_no DESC LIMIT 3 " ;
								...
								print"<div class=\"world-news-grid\">";
									echo'<img src="../'.$pic1.'" width="145px" height="130px" alt=""/>';
								...
								while($row = mysql_fetch_assoc($retval))
									{
									 ...
									 print"<li>";
										print"<a href='singlepage.php?news_id=".$row['sr_no']."'>";echo'<img src="../'.$pic1.'" width="145px" height="130px" alt=""/>';print"</a>";						
									 print"</li>";
												}
								?>
								 </ul>
			...
			$sql = "SELECT sr_no,LEFT(topic,200) AS topica,few_d,pic1 FROM news WHERE category LIKE '%Sports%' ORDER BY sr_no DESC LIMIT 4 " ;
							...
							print"<div class=\"editor\">";
								print"<a href='singlepage.php?news_id=".$row['sr_no']."'>";echo'<img src="../'.$pic1.'" width="145px" height="150px" alt=""/>';print"</a>";
