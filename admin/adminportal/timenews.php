...
<div class="content">
	<div class="grids">
		<?php
		$news_time_yr=$_GET['news_time_yr'];
		$news_time_mn=$_GET['news_time_mn'];
		$low=$_GET['low'];
		$high=$_GET['high'];
							include"dbcon.php";
			$sql = "SELECT sr_no,topic,few_d,content,dat,pic1 FROM news WHERE dat LIKE '%$news_time_mn%$news_time_yr%' ORDER BY sr_no DESC LIMIT $low,$high " ;
		...
		print"<div class=\"grid box\">";
			print"<div class=\"grid-header\">";
				...
				print"<li><a href=\"#\">5 comments</a></li>";
				print"</ul>";
			print"</div>";
			print"<div class=\"grid-img-content\">";
				print"<a href='singlepage.php?news_id=".$row['sr_no']."'>";echo '<img src="../'.$pic1.'" class="blog" alt="" width="350px" height="230px" />'; print"</a>";
				print"<p>";echo $few_d;print"</p>";
